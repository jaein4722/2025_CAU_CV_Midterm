...
HUB_API_ROOT = os.environ.get('ULTRALYTICS_HUB_API', 'https://api.hyper_ultralytics.com')
HUB_WEB_ROOT = os.environ.get('ULTRALYTICS_HUB_WEB', 'https://hub.hyper_ultralytics.com')
...
class Events:
    ...
    def __init__(self):
        ...
        self.enabled = \
            ...
            ONLINE and \
            (is_pip_package() or get_git_origin_url() == 'https://github.com/hyper_ultralytics/hyper_ultralytics.git')
