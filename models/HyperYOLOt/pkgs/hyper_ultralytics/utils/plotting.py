...
from hyper_ultralytics.utils import LOGGER, TryExcept, ops, plt_settings, threaded
...
class Colors:
    """
    Ultralytics default color palette https://hyper_ultralytics.com/.
...
@TryExcept()  # known issue https://github.com/hyper_ultralytics/yolov5/issues/5395
@plt_settings()
...
def save_one_box(xyxy, im, file=Path('im.jpg'), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from hyper_ultralytics.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/hyper_ultralytics/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file='path/to/results.csv', dir='', segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from hyper_ultralytics.utils.plotting import plot_results
