...
def handle_yolo_settings(args: List[str]) -> None:
    ...
    Example:
        ...
        ```
    """
    url = 'https://docs.hyper_ultralytics.com/quickstart/#hyper_ultralytics-settings'  # help URL
    try:
        if any(args):
            if args[0] == 'reset':
...
def entrypoint(debug=''):
    """
    This function is the hyper_ultralytics package entrypoint, it's responsible for parsing the command line arguments passed
    to the package.
    ...
    # Show help
    LOGGER.info(f'💡 Learn more at https://docs.hyper_ultralytics.com/modes/{mode}')
