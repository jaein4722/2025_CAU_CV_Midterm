...
class Model(nn.Module):
    ...
    Methods:
        ...
        predict(source=None, stream=False, **kwargs) -> List[hyper_ultralytics.engine.results.Results]:
            Performs prediction using the YOLO model.

    Returns:
        list(hyper_ultralytics.engine.results.Results): The prediction results.
    """
    ...
    def is_hub_model(model):
        ...
        return any((
            model.startswith(f'{HUB_WEB_ROOT}/models/'),  # i.e. https://hub.hyper_ultralytics.com/models/MODEL_ID
    ...
    def predict(self, source=None, stream=False, predictor=None, **kwargs):
        ...
        is_cli = (sys.argv[0].endswith('yolo') or sys.argv[0].endswith('hyper_ultralytics')) and any(
    ...
    def tune(self, use_ray=False, iterations=10, *args, **kwargs):
        """
        Runs hyperparameter tuning, optionally using Ray Tune. See hyper_ultralytics.utils.tuner.run_ray_tune for Args.
