...
from hyper_ultralytics.utils import DEFAULT_CFG, LOGGER, callbacks, colorstr, remove_colorstr, yaml_print, yaml_save
from hyper_ultralytics.utils.plotting import plot_tune_results
...
class Tuner:
    ...
    def __init__(self, args=DEFAULT_CFG, _callbacks=None):
        ...
        LOGGER.info(f"{self.prefix}Initialized Tuner instance with 'tune_dir={self.tune_dir}'\n"
                    f'{self.prefix}💡 Learn about tuning at https://docs.hyper_ultralytics.com/guides/hyperparameter-tuning')
