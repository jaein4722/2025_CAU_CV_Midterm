...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        self.metadata = {
            ...
            'author': 'Ultralytics',
            'license': 'AGPL-3.0 https://hyper_ultralytics.com/license',
    ...
    def export_saved_model(self, prefix=colorstr('TensorFlow SavedModel:')):
        ...
        check_version(tf.__version__,
                      ...
                      name='tensorflow',
                      verbose=True,
                      msg='https://github.com/hyper_ultralytics/hyper_ultralytics/issues/5161')
    ...
    def export_edgetpu(self, tflite_model='', prefix=colorstr('Edge TPU:')):
        ...
        LOGGER.warning(f'{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/hyper_ultralytics/hyper_ultralytics/issues/1185')
