...
from models.LightweightOB.pkgs.models.common import Conv
from models.LightweightOB.pkgs.models.experimental import attempt_load
from models.LightweightOB.pkgs.models.yolo import Detect
from models.LightweightOB.pkgs.utils.activations import SiLU
from models.LightweightOB.pkgs.utils.datasets import LoadImages
from models.LightweightOB.pkgs.utils.general import colorstr, check_dataset, check_img_size, check_requirements, file_size, print_args, \
    set_logging, url2file
from models.LightweightOB.pkgs.utils.torch_utils import select_device
...
def export_saved_model(model, im, file, dynamic,
    ...
    try:
        ...
        from models.LightweightOB.pkgs.models.tf import TFModel, TFDetect
...
def export_tflite(keras_model, im, file, int8, data, ncalib, prefix=colorstr('TensorFlow Lite:')):
    ...
    try:
        import tensorflow as tf
        from models.LightweightOB.pkgs.models.tf import representative_dataset_gen
