...
from models.LightweightOB.pkgs.utils.downloads import gsutil_getsize
from models.LightweightOB.pkgs.utils.metrics import box_iou, fitness
...
def strip_optimizer(f='best.pt', s=''):  # from models.LightweightOB.pkgs.utils.general import *; strip_optimizer()
