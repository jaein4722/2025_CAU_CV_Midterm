...
from models.YOGAn.pkgs.utils.datasets import exif_transpose, letterbox
from models.YOGAn.pkgs.utils.general import colorstr, increment_path, make_divisible, non_max_suppression, save_one_box, \
    scale_coords, xyxy2xywh
from models.YOGAn.pkgs.utils.plots import Annotator, colors
from models.YOGAn.pkgs.utils.torch_utils import time_sync
...
class C3TR(C3):
	...
	def __init__(self,c1, c2, n=1, shortcut= True, g=1, e=0.5):
		super().__init__(c1, c2, n=1, shorcut=shortcut, g=1, e=e)
		c_ = int(c2*e)
...
class AutoShape(nn.Module):
	...
	def forward(self, imgs, size=640, augment = False, profile= False):
		...
		if isinstance(imgs,torch.Tensor): # torch
			with amp.autocast(device_type='cuda', enabled=p.device.type != 'cpu'):
